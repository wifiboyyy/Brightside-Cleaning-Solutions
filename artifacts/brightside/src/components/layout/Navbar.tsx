              ...
              {navLinks.map((link) => (
                <button
                  ...
                  className={cn(
                    ...
                    isScrolled ? "text-slate-600 hover:text-primary" : "text-[#0f2472] font-bold hover:text-[#0f2472]/70"
                  )}
                >
                  {link.name}
                </button>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className={cn(
                  ...
                  isScrolled ? "text-primary" : "text-[#0f2472] hover:text-[#0f2472]/70"
                )}
              >
              ...
              <Button 
                className={cn(
                  "font-bold border-0 shadow-md transition-colors",
                  isScrolled
                    ? "bg-[#f5a623] hover:bg-[#e09510] text-[#0f2472]"
                    : "bg-[#0f2472] hover:bg-[#0a1a5c] text-white"
                )}
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className={cn(
                ...
                isScrolled ? "text-slate-900" : "text-[#0f2472]"
              )}
            >
